"""
step_7.11_shadow_price_reduced_cost.py
...
Outputs:
    step_7_outputs/step_7.11_shadow_prices_growth_optimum.csv
    step_7_outputs/step_7.11_shadow_prices_PHB_optimum.csv
    step_7_outputs/step_7.11_reduced_costs_growth_optimum.csv
    step_7_outputs/step_7.11_reduced_costs_PHB_optimum.csv
    step_7_outputs/step_7.11_limiting_nutrients_summary.txt
    step_7_outputs/step_7.11_shadow_price_reduced_cost.png
"""
...
def main():
    ...
    for label, obj_id in [("growth_optimum", biomass.id), ("PHB_optimum", phb.id)]:
        ...
        sp_csv = os.path.join(OUTPUT_DIR, f"step_7.11_shadow_prices_{label}.csv")
        rc_csv = os.path.join(OUTPUT_DIR, f"step_7.11_reduced_costs_{label}.csv")
    ...
    summary_lines = ["STEP 7.11 — Shadow Price & Reduced Cost Summary", "=" * 70]
    ...
    summary_path = os.path.join(OUTPUT_DIR, "step_7.11_limiting_nutrients_summary.txt")
    ...
    png_path = os.path.join(OUTPUT_DIR, "step_7.11_shadow_price_reduced_cost.png")
