"""
step_7.20_essential_reaction_knockout_screen.py
...
strain-design steps that follow (step_7.21, step_7.22).

Outputs:
    step_7_outputs/step_7.20_knockout_screen_full.csv
    step_7_outputs/step_7.20_essential_critical_bar_chart.png
"""
...
def main():
    ...
    csv_path = os.path.join(OUTPUT_DIR, "step_7.20_knockout_screen_full.csv")
    ...
    png_path = os.path.join(OUTPUT_DIR, "step_7.20_essential_critical_bar_chart.png")
