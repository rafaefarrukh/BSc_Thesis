...
Outputs:
    step_7_outputs/step_7.17_single_knockout_coupling_scores.csv
    step_7_outputs/step_7.17_best_double_knockout_coupling.csv
    step_7_outputs/step_7.17_strain_design_summary.txt
"""
...
def main():
    ...
    if TRY_CAMEO_FIRST:
        ...
        if cameo_result is not None:
            csv_path = os.path.join(OUTPUT_DIR, "step_7.17_cameo_optknock_results.csv")
    ...
    single_csv = os.path.join(OUTPUT_DIR, "step_7.17_single_knockout_coupling_scores.csv")
    ...
    double_csv = os.path.join(OUTPUT_DIR, "step_7.17_best_double_knockout_coupling.csv")
    ...
    # --- Summary -----------------------------------------------------------------
    lines = ["STEP 7.17 — Strain Design (heuristic growth/PHB coupling search)", "=" * 70]
    ...
    summary_path = os.path.join(OUTPUT_DIR, "step_7.17_strain_design_summary.txt")
